 ...
 * Table layout follows NVIDIA tegracam drivers (imx219_mode_tbls.h,
 * Copyright (c) 2014-2019 NVIDIA CORPORATION).
 */

#ifndef __OV5647_MODE_TBLS_H__
#define __OV5647_MODE_TBLS_H__
...
static const ov5647_reg ov5647_start_stream[] = {
	{0x4202, 0x00},
	{0x0100, 0x01},
	{OV5647_TABLE_END, 0x00}
};

static const ov5647_reg ov5647_stop_stream[] = {
	{0x4202, 0x0f},
	{0x0100, 0x00},
	{OV5647_TABLE_END, 0x00}
};

static const ov5647_reg ov5647_mode_2592x1944_15fps[] = {
	{0x0100, 0x00},
	{0x0103, 0x01},
...
static const ov5647_reg ov5647_mode_1920x1080_30fps[] = {
	{0x0100, 0x00},
	{0x0103, 0x01},
	{OV5647_TABLE_WAIT_MS, 10},
	{0x3034, 0x1a},
...
static const ov5647_reg ov5647_mode_1296x972_30fps[] = {
	{0x0100, 0x00},
	{0x0103, 0x01},
	{OV5647_TABLE_WAIT_MS, 10},
	{0x3034, 0x1a},
...
/* 1280x720 at 60 fps: the binned mode above with the vertical window cut
 * to 1464 array rows, which is what buys the frame rate. Same binning,
 * PLL and line length.
 *
 * The window starts at row 244, column 0 and is a multiple of four rows
 * high. Binning averages same-coloured pixels in groups of four rows, so
 * a window starting two rows in comes out GRBG instead of BGGR.
 */
static const ov5647_reg ov5647_mode_1280x720_60fps[] = {
	{0x0100, 0x00},
	{0x0103, 0x01},
	{OV5647_TABLE_WAIT_MS, 10},
	{0x3034, 0x1a},
